      ...
      <main className="cart-container">
        ...
        <Box maxW="804px" w="100%">
          ...
          <TableHeader style={{
            ...
            <TableRow>
              <TableColumnHeader style={{ border: borderStyle, fontWeight: "bold" }}>
                Название
              </TableColumnHeader>
              <TableColumnHeader style={{ border: borderStyle, fontWeight: "bold" }}>
                Цена
        ...
        <Box className="cart-summary">
          <Text><strong>Итого: 8.75€</strong></Text>
          <Button colorPalette="orange" size="md">Заказать все</Button>
        </Box>
