import { Input, Button, NumberInput, Stack, Select, Portal, createListCollection, } from "@chakra-ui/react";
...
const cancelOptions = createListCollection({
  items: [
    { label: "Нет, не отменить", value: "no" },
    ...
    <>
      ...
      <main className="subscribe-page">
        <div className="title-wrapper">
            ...
            <span className="date">(03.05.2025)</span>
            </h1>
        </div>
        ...
        <div className="subscribe-layout">
            ...
            <div>
                ...
                <div className="form-group">
                  <label className="form-control">Этаж</label>
                    <Stack gap="5" width="100%">
                        <NumberInput.Root size="sm" defaultValue="6">
                            <NumberInput.Control />
                            <NumberInput.Input />
                        </NumberInput.Root>
                    </Stack>
                ...
                <div>
                    <label className="form-control">Выбрать другой напиток</label>
                ...
                <div>
                    <label className="form-control">Выбрать другой продукт(1)</label>
                ...
                <div>
                    <label className="form-control">Выбрать другой продукт(2)</label>
          ...
          <div className="subscribe-card_data">
            ...
            <Button colorPalette="orange" size="sm" fontWeight="bold" fontSize="12px" width="full">
              Отменить подписку
            </Button>
          </div>
        </div>
